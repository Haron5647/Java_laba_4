...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        graphicsStroke = new BasicStroke(4.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 10.0f, new float[] {16,4,8, 4,4,4,8,4,16}, 0.0f);
    ...
    protected void paintAxis(Graphics2D canvas, double offsetX, double offsetY) {
        ...
        if (minY <= 0.0 && maxY >= 0.0) {
            ...
            Point2D.Double midpoint = xyToPoint(xMid, 0, offsetX, offsetY);
            canvas.drawString("0", (float) midpoint.getX()-20, (float) midpoint.getY() - 10);
        }
    }
